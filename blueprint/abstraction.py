...
# Add submission dir so we can import the equity engine
...
def enumerate_all_turns():
    """
    Enumerate all C(27,4) = 17550 possible turn boards.

    Returns:
        list of (c1, c2, c3, c4) tuples with c1 < c2 < c3 < c4
    """
    return list(itertools.combinations(range(27), 4))


def enumerate_all_rivers():
    """
    Enumerate all C(27,5) = 80730 possible river boards.

    Returns:
        list of (c1, c2, c3, c4, c5) tuples with c1 < c2 < c3 < c4 < c5
    """
